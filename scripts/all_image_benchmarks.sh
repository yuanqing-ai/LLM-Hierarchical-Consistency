...
python evaluation/vllm/internvl/eval_img_natrual_plant.py --prompt_order \
--test_set data/annotations/similar_choices/inat21_plantae_with_similar_choice.jsonl \
--output_file your_output_file

python evaluation/vllm/internvl/eval_img_artifact.py --prompt_order \
--test_set data/annotations/similar_choices/imagenet_artifact_with_similar_choice.jsonl \
--output_file your_output_file

python evaluation/vllm/internvl/eval_img_animal.py --prompt_order \
--test_set data/annotations/similar_choices/imagenet_animal_with_similarity_choice.jsonl \
--output_file your_output_file

python evaluation/vllm/internvl/eval_img_cub.py --prompt_order \
--test_set data/annotations/similar_choices/CUB200_with_similarity_choice.jsonl \
--output_file your_output_file

python evaluation/vllm/internvl/eval_img_food.py --prompt_order \
--test_set data/annotations/similar_choices/Food101_with_similar_choice.jsonl \
--output_file your_output_file
...
python evaluation/vllm/qwen/eval_natural_animal.py --prompt_order  \
--test_set data/annotations/similar_choices/inat21_animalia_with_similar_choice.jsonl \
--model_path your_qwen_7B_path \
--output_file your_output_file

python evaluation/vllm/qwen/eval_natural_plant.py --prompt_order  \
--test_set data/annotations/similar_choices/inat21_plantae_with_similar_choice.jsonl \
--model_path your_qwen_7B_path \
--output_file your_output_file

python evaluation/vllm/qwen/eval_artifact.py --prompt_order  \
--test_set data/annotations/similar_choices/imagenet_artifact_with_similar_choice.jsonl \
--model_path your_qwen_7B_path \
--output_file your_output_file

python evaluation/vllm/qwen/eval_animal.py --prompt_order  \
--test_set data/annotations/similar_choices/imagenet_animal_with_similarity_choice.jsonl \
--model_path your_qwen_7B_path \
--output_file your_output_file  

python evaluation/vllm/qwen/eval_CUB.py --prompt_order  \
--test_set data/annotations/similar_choices/CUB200_with_similarity_choice.jsonl \
--model_path your_qwen_7B_path \
--output_file your_output_file     

python evaluation/vllm/qwen/eval_Food101.py --prompt_order  \
--test_set data/annotations/similar_choices/Food101_with_similar_choice.jsonl \
--model_path your_qwen_7B_path \
--output_file your_output_file
