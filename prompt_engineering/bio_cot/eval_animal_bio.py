...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_file",
        type=str,
        default="/projectnb/ivc-ml/yuwentan/LLaVA-NeXT/QWEN_EVAL/bio/animal.json",
    ...
    parser.add_argument(
        "--test_set",
        type=str,
        default="/projectnb/ivc-ml/yuwentan/LLaVA-NeXT/Inat_code/Animalia_with_similar_choice.jsonl",
