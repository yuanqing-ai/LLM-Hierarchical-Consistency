...
def test_internvl(json_file, output_file, prompt_order,internvl_3):
    # We recommend enabling flash_attention_2 for better acceleration and memory saving, especially in multi-image and video scenarios.
    if internvl_3:
        path = '/projectnb/ivc-ml/yuan/model_zoo/InternVL3-8B'
    else:
...
def infer_level(prompt_template, choice_map, tokenizer, model,pixel_values):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--internvl_3",
        action="store_true",
        help="specify the internvl version"
    )
    parser.add_argument(
        "--test_set",
        type=str,
    ...
    test_internvl(json_file, args.output_file, args.prompt_order, args.internvl_3)