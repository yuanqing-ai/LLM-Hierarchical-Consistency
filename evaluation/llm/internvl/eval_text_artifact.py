...
def test_internvl(json_file, output_file, prompt_order,internvl_3):
    ...
    if internvl_3:
        path = '/projectnb/ivc-ml/yuan/model_zoo/InternVL3-8B' # Replace with your path
    else:
        path = '/projectnb/ivc-ml/yuan/model_zoo/InternVL2_5-8B' # Replace with your path
...
def infer_level(prompt_template, choice_map, tokenizer, model):
    ...
    try:
        ...
        response, history = model.chat(tokenizer, question, generation_config, history=None, return_history=True)
...
if __name__ == "__main__":
    ...
    test_internvl(args.test_set, args.output_file, args.prompt_order, args.internvl_3)