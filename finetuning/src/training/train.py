...
def train():
    ...
    if training_args.vision_lora and not training_args.freeze_vision_tower:
        ...
        if not training_args.vision_lora and (training_args.merger_lr is None):
            training_args.lora_namespan_exclude += ["visual"]
        elif not training_args.vision_lora and (training_args.merger_lr is not None):
            training_args.lora_namespan_exclude += ["visual.blocks"]
